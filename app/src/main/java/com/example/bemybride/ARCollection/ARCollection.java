package com.example.bemybride.ARCollection;
...
public class ARCollection extends AppCompatActivity {
    private static final String TAG="ARCollection";
    private Context mContext=ARCollection.this;
