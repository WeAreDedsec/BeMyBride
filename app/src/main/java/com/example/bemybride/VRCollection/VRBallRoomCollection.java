package com.example.bemybride.VRCollection;
...
public class VRBallRoomCollection extends AppCompatActivity{
    private static final String TAG="VRBallRoomCollection";
    private Context mContext=VRBallRoomCollection.this;
